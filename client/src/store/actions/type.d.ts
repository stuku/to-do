...
export type ToDoActions = GetToDosAction | AddToDoAction | UpdateToDoAction | DeleteToDoAction | AddToDoSuccessFullyAction | UpdateToDoSuccessFullyAction| ChangePageNumberAction| ChangePageSizeAction;